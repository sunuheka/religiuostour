...
<body class="budhhist itinerary">
    ...
    <section class="sectionInnerBanner" style="background-image: url('./assets/img/Bodhgaya Prayer DSC_1585.jpg');">
        ...
        <div class="col-sm-6 right-col">
            <div class="contentBlockVideo">
                <div class="videoThumbnail">
                    <iframe height="408" src="https://www.youtube.com/embed/tgbNymZ7vqY"></iframe>
                </div> 
            </div>
        </div>
        </div>
