...
<p>Come, discover the path to <a href="">enlightenment</a>, towards Buddha by train.</p>
    ...
    <?php include 'includes/sikh/imagetext_content.php';?>
    <?php //include 'includes/news-blog.php';?>
    <?php include 'includes/sikh/gallery.php';?>
    <?php include 'includes/sikh/video.php';?>
    <?php include 'includes/sikh/location.php';?>
    <?php include 'includes/sikh/circuits.php';?>
    <?php include 'includes/sikh/map.php';?>
    <?php include 'includes/sikh/testimonial.php';?>
